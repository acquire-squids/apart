...
#[cfg(test)]
mod access_lhs_is_call {
    const SOURCE: &str = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/lang/tests/",
        "access_lhs_is_call.txt"
    ));

    #[test]
    fn access_lhs_is_call() {
        let mut out = vec![];
    ...
    #[test]
    fn access_lhs_is_call_register() {
        let mut out = vec![];
...
#[cfg(test)]
mod callee_is_access {
    const SOURCE: &str = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/lang/tests/",
        "callee_is_access.txt"
    ));
